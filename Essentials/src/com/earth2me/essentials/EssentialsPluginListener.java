...
public class EssentialsPluginListener implements Listener, IConf
{
	...
	public void onPluginEnable(final PluginEnableEvent event)
	{
		...
		if (!ess.getPaymentMethod().hasMethod() && ess.getPaymentMethod().setMethod(ess.getServer().getPluginManager()))
		{
			ess.getLogger().log(
					Level.INFO,
					"Payment method found (" + ess.getPaymentMethod().getMethod().getLongName() + " version: " + ess.getPaymentMethod().getMethod().getVersion() + ")");
		}
	}
	...
	public void onPluginDisable(final PluginDisableEvent event)
	{
		...
		if (ess.getPaymentMethod() != null && ess.getPaymentMethod().hasMethod() && ess.getPaymentMethod().checkDisabled(
				event.getPlugin()))
		{
